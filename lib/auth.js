...
// File-backed sessions — survive server restarts
...
function authMiddleware(req, res, next) {
  if (req.path === '/login.html' || req.path === '/login' || req.path.startsWith('/api/auth/') || req.path.startsWith('/api/health') || req.path.startsWith('/api/stats')) {
    return next();
  }
